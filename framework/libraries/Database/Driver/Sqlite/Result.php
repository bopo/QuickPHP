 ...
 */
class QuickPHP_Database_Driver_SQLite_Result extends QuickPHP_Database_Result
{
    ...
    public function __construct($result, $sql, $as_object)
    {
        ...
        $this->_total_rows = sqlite_num_rows($this->_result);
    }
    ...
    public function current()
    {
        ...
        {
            return $this->_array2object(sqlite_fetch_array($this->_result));
        }
        elseif(is_string($this->_as_object))
        {
            return sqlite_fetch_single($this->_result, $this->_as_object);
        }
        else
        {
