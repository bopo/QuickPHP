 ...
 *
 * $Id: Memcache.php 8320 2011-10-05 14:59:55Z bopo $
 *
 * @author BoPo <ibopo@126.com>
 ...
 * @package Cache
 */
class QuickPHP_Cache_Driver_Memcache implements QuickPHP_Cache_Interface
{
    protected $backend;
    protected $flags;
    ...
    public function __construct($config = array())
    {
        if( ! extension_loaded('memcache'))
            throw new QuickPHP_Cache_Exception('extension_not_loaded', array('memcache'));
