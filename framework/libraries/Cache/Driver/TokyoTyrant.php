 ...
 * @package Cache
 */
class QuickPHP_Cache_Driver_TokyoTyrant implements QuickPHP_Cache_Interface
{
    protected $backend;
    protected $flags;
    ...
    public function __construct($config = array())
    {
        if( ! extension_loaded('tokyo_tyrant'))
            throw new QuickPHP_Cache_Exception('extension_not_loaded', array('tokyo_tyrant'));

        $this->backend  = new TokyoTyrant($server['host']);
    }
    ...
    {
        return ($id === true) ? $this->backend->vanish() : $this->backend->out($id);
    }
