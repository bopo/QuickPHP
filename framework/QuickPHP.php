 ...
 * http://framework.quickphp.net/license/new-bsd
 * If you did not receive a copy of the license and are unable to
 * obtain it through the world-wide-web, please send an email
 * to license@quickphp.net so we can send you a copy immediately.
 *
 * @category   QuickPHP
 * @package    QuickPHP
 ...
 * @version    $Id: QuickPHP.php 8761 2012-01-15 05:10:59Z bopo $
 */
