 ...
 * @version     $Id: security.php 8320 2011-10-05 14:59:55Z bopo $
 */
class QuickPHP_security
{

    /**
     * @var  string  key name used for token storage
     */
    public static $token_name = 'QuickPHP:Security:Token';
    ...
    public static function xss_clean($str)
    {
        ...
        $str = html_entity_decode($str, ENT_COMPAT, QuickPHP::$charset);
    ...
    public static function token($new = false)
    {
        ...
        {
            $token = strtoupper(sha1(uniqid('security')));
