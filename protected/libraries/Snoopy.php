...
\*======================================================================*/
    ...
    function expandfetch($URI)
    {
        if ($this->fetch($URI))
        {
            ...
            {
                $rawlinks = $this->_striplinks($this->results);
            }

            if($this->expandlinks)
                $expandlinks = $this->_expandlinks($rawlinks, $URI);

            var_dump($rawlinks, $expandlinks);die;

            $this->results = str_replace($rawlinks, $expandlinks, $this->results);
